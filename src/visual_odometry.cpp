...
namespace myslam 
{
  ...
  void VisualOdometry::extractKeyPoints(const Mat& left, const Mat& right)
  {
    ...
    cout << "*******************************" << endl;
    cout<<"提取特征点用时: "<<timer.elapsed()<<endl;
  }
  ...
  void VisualOdometry::ComputeStereoMatches()
  {
    ...
    cout<<"左右图像匹配用时: "<<timer.elapsed()<<endl;
  }
 ...
 void VisualOdometry::featureMatching()
 {
   ...
   cout<<"前后图像匹配用时: "<<timer.elapsed()<<endl;
 }
...
void VisualOdometry::poseEstimationPnP()
{
    ...
    cout<<"计算pnp用时: "<<timer.elapsed()<<endl;
    ...
    cout<<"g2o优化用时: "<<timer.elapsed()<<endl;
}
